...
import com.robertconstantindinescu.nearbyplaces.adapters.DirectionStepAdapter
import com.robertconstantindinescu.nearbyplaces.databinding.ActivityDirectionBinding
import com.robertconstantindinescu.nearbyplaces.databinding.BottomSheetLayoutBinding
                ...
                locationViewModel.getDirection(url).collect {
                    when (it) {
                        ...
                        is State.Succes -> {
                            ...
                            //añadimos las lineas al mapa.
                            mGoogleMap?.addPolyline(options)
                            //defines la localizacion start. Que la coges de la ap
