...
import com.robertconstantindinescu.nearbyplaces.databinding.ActivityLoginBinding
                    ...
                    loginViewModel.login(email, password).collect {
                        when (it) {
                            ...
                            is State.Succes -> {
                                ...
                                //si se ha hehco el login correctamente, entonces nos camos al main Activity
                                //y terminamos con esta activity poniendo finish()
